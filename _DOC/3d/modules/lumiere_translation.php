...
// MODULE........ modules / translation d'une source de lumière
...
<title>3D-Lumière translation (1.0)</title>
</head>
...
if (!isset($act) || !$act) {
   ...
   echo '                         <td><font face="Arial"><input type="text" name="lumiere" size="10"></font></td>';
   echo '                       </tr>';
   echo '                     </table>';
   echo '                   </div>';
   echo '                 </td>';
   ...
   switch ($act) {
      case 'rec':
         ...
         for ($id_img = 1; $id_img <= $nb_img; $id_img++)
            ...
            $act  = 'lumiere;translation;' .$id_obj .';' .$x .';' .$y .';' .$z .';';
