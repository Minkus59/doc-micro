...
// MODULE........ animation / rotation d'un objet.
...
<title>3D-Objet rotation (1.1)</title>
</head>
...
if (!isset($act) || !$act) {
   ...
   echo '                          <td><font face="Arial"><input type="text" size="10" name="objet"></font>';
   echo '                       </tr>';
   echo '                       <tr>';
   echo '                          <td width="80"><font face="Arial">pivot</font></td>';
   echo '                          <td><font face="Arial"><input type="text" size="10 name="pivot"></font>';
   echo '                       </tr>';
   echo '                       <tr>';
   ...
   switch ($act) {
      case 'rec':
         ...
         for ($id_img = 1; $id_img <= $nb_img; $id_img++)
            ...
            $act  = 'objet;rotation;' .$id_obj .';' .$a .';' .$b .';' .$g .';' .$pivot .';';
