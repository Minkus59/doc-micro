...
if (!isset($act) || !$act) {
   ...
   echo '                         <td><font face="Arial"><input type="text" name="objet" size="20"></font></td>';
   echo '                       </tr>';
   echo '                     </table>';
   echo '                   </div>';
   echo '                 </td>';
         ...
         for ($id_img = 1; $id_img <= $nb_img; $id_img++)
            ...
            switch ($variation)
               ...
               case 'lineaire':
                  ...
                  $i = round(calculer_variation_lineaire($depart_i, $arrivee_i, $id_img, $nb_img));
                  break;
               }
            $act  = 'objet;rvbi;' .$id_obj .';' .$r .';' .$v .';' .$b .';' .$i .';';
