<?php
/***************************************/
// PROGRAMME..... navigateur 3D stéréo
// MODULE........ Visualisation stéréo d'une scène en appelant le moteur 3D avec paramètres de navigation.
...
<HTML>
<HEAD>
<TITLE>3D-Navigateur stéréo (1.0)</TITLE>
...
function afficher()
   ...
   top.cible.document.images[0].src = "http://" +serveur_moteur_3d + "<?php echo $params->dir_racine; ?>" +"/3d_aff.php?dx="+dx +"&dy="+dy +"&dz="+dz +"&da="+da +"&db="+db +"&dg="+dg +"&fil=" +filaire +"&imgx=" +imgx +"&imgy=" +imgy +"&imgz=" +imgz +"&imge=" +eclairage +"&imgs=" +imgs +"&imgf=" +imgf +"&scn=" +scn +"&dbsrv=" +serveur_database +"&fin=" +fin +"&fout=" +fout +"&p1=" +p1;
   top.cible.document.images[1].src = "http://" +serveur_moteur_3d + "<?php echo $params->dir_racine; ?>" +"/3d_aff.php?dx="+dx +"&dy="+dy +"&dz="+dz +"&da="+da +"&db="+eval(db-2) +"&dg="+dg +"&fil=" +filaire +"&imgx=" +imgx +"&imgy=" +imgy +"&imgz=" +imgz +"&imge=" +eclairage +"&imgs=" +imgs +"&imgf=" +imgf +"&scn=" +scn +"&dbsrv=" +serveur_database +"&fin=" +fin +"&fout=" +fout +"&p1=" +p1;
...
<tr>
   ...
   <tr>
      ...
      <td><input type="text" name="imgx" size="3" onchange="afficher()" value="150"></td>
   </tr>
   <tr>
