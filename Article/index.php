...
$automne2_debut=mktime(0,0,0,10,7,14);
$automne2_fin=mktime(0,0,0,12,21,14);
...
<p><div id="text">Doc-Micro vous propose ses scripts pret a l'emploi pour les webmasters.<hr></hr></div>
<div id="cadre3">

<div id="photo_article"><a href=""><img src=""/></a></div>
<div id="article">
Formulaire d'incription complet avec insertion des données clients dans une base de donnée (PHP/Mysql)
Prix : 100€ HT
</div>

<div id="photo_article"><a href=""><img src=""/></a></div>
<div id="article">
Formulaire de devis complet avec insertion des données clients dans une base de donnée (PHP/Mysql) avec reception d'un mail d'avertissement
Prix : 100€ HT
</div>
