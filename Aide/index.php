...
<input type="email" name="test_date" required="required" placeholder="Saisissez ce champ"/><br />

<input type="password" name="test_" required="required" placeholder="Saisissez ce champ"/><br />
